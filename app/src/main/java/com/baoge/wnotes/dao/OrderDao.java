...
public class OrderDao extends AbstractDao<Order, Long> {
    ...
    public static class Properties {
        ...
        public final static Property PatientName = new Property(21, String.class, "patientName", false, "PATIENT_NAME");
        public final static Property PatientId = new Property(22, String.class, "patientId", false, "PATIENT_ID");
        public final static Property PatientPhone = new Property(23, String.class, "patientPhone", false, "PATIENT_PHONE");
    }
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"'order'\" (" + //
                ...
                "\"PATIENT_NAME\" TEXT," + // 21: patientName
                "\"PATIENT_ID\" TEXT," + // 22: patientId
                "\"PATIENT_PHONE\" TEXT);"); // 23: patientPhone
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, Order entity) {
        ...
        if (patientName != null) {
            stmt.bindString(22, patientName);
        }
 
        String patientId = entity.getPatientId();
        if (patientId != null) {
            stmt.bindString(23, patientId);
        }
 
        String patientPhone = entity.getPatientPhone();
        if (patientPhone != null) {
            stmt.bindString(24, patientPhone);
        }
    }
    ...
    public Order readEntity(Cursor cursor, int offset) {
        Order entity = new Order( //
            ...
            cursor.isNull(offset + 21) ? null : cursor.getString(offset + 21), // patientName
            cursor.isNull(offset + 22) ? null : cursor.getString(offset + 22), // patientId
            cursor.isNull(offset + 23) ? null : cursor.getString(offset + 23) // patientPhone
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Order entity, int offset) {
        ...
        entity.setPatientName(cursor.isNull(offset + 21) ? null : cursor.getString(offset + 21));
        entity.setPatientId(cursor.isNull(offset + 22) ? null : cursor.getString(offset + 22));
        entity.setPatientPhone(cursor.isNull(offset + 23) ? null : cursor.getString(offset + 23));
     }
